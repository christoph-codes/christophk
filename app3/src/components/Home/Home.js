    ...
    return (
        ...
        <Section id="my-story" bgColor="white">
          ...
          <p>
            ...
            called{" "}
            <a href="https://thekirkconcept.com" rel="noopener noreferrer" target="_blank">
              The Kirk Concept
            </a>{" "}
          ...
          <p>
            ...
            <a href="https://unlv.edu" rel="noopener noreferrer" target="_blank">
              UNLV.
            </a>{" "}
            ...
            to binge-watch.{" "}
            <a href="https://www.hbo.com/silicon-valley" rel="noopener noreferrer" target="_blank">
              Silicon Valley
            </a>{" "}
          ...
          <p>
            ...
            <a href="https://www.equippdlife.com" rel="noopener noreferrer" target="_blank">
              Equippd
            </a>
          ...
          <p>
            ...
            <a href="https://www.thenextbill.com" rel="noopener noreferrer" target="_blank">
              NextBill
            </a>{" "}
            written in
            ...
            <a href="https://www.inthisorder.app" rel="noopener noreferrer" target="_blank">
              InThisOrder
            </a>{" "}
            written in{" "}
